...
extension UIColor {
    ...
    static var applicationTint: UIColor {
        return UIColor(named: "Application Tint Color")!
    }
    ...
    static var applicationTertiaryTint: UIColor {
        return UIColor(named: "Application Tertiary Tint Color")!
    }
    ...
    static var applicationBadge: UIColor {
        return UIColor(named: "Application Badge Color")!
    }
    ...
    static var applicationTertiaryBackground: UIColor {
        return UIColor(named: "Application Tertiary Background Color")!
    }
    ...
    static var applicationNavigationBar: UIColor {
        return UIColor(named: "Application Navigation Bar Color")!
    }
